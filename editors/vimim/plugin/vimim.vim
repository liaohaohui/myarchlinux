...
function! s:vimim_bare_bones_vimrc()
    ...
    set fencs=utf8,ucs-bom,chinese,gb18030 gfn=Courier_New:h12:w7
...
function! s:vimim_dictionary_statusline()
    ...
    let one .= " zhengma cangjie yong wu wubijd "
    ...
    let one .= " abc revision date google "
...
function! s:vimim_plug_and_play()
    ...
    inoremap <unique> <C-d>  <C-R>=g:Vimim_chinese()<CR>
